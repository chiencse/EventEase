...
export class FollowerResponseDto {
    ...
    @ApiProperty({
        description: 'Trạng thái theo dõi (true nếu đang theo dõi, false nếu không theo dõi)',
        example: true
    })
    isFollow: boolean;

    @ApiProperty({
        description: 'Trạng thái được theo dõi (true nếu được theo dõi, false nếu không được theo dõi)',
        example: true
    })
    isFollowed: boolean;
